...
from jsbgym.rewards import (
    Reward,
    AsymptoticErrorComponent,
    ErrorComponent,
...
class TestReward(unittest.TestCase):
    ...
    def test_shaping_reward_reward(self):
        ...
        expected_r = sum(base_reward + shaping_reward) / len(
            base_reward + shaping_reward
        )
        self.assertAlmostEqual(expected_r, reward.agent_reward())
...
class AbstractTestErrorComponent(unittest.TestCase, ABC):
    ...
    def get_component_target_property(
        self,
        name=default_name,
...
class TestAsymptoticErrorComponent(AbstractTestErrorComponent):
    ...
    def test_calculate_same_perfect_states_shaping_terminal(self):
        ...
        potential_diff = (
            component.POTENTIAL_BASED_DIFFERENCE_TERMINAL_VALUE - self.PERFECT_POTENTIAL
        )
        self.assertAlmostEqual(
            potential_diff, component.calculate(state, last_state, terminal)
        )
...
class TestLinearShapingComponent(AbstractTestErrorComponent):
    ...
    def test_calculate_get_potential_perfect_state_non_terminal(self):
        ...
        self.assertAlmostEqual(
            self.PERFECT_POTENTIAL, component.get_potential(state, terminal)
        )
    ...
    def test_calculate_get_potential_perfect_state_terminal(self):
        ...
        self.assertAlmostEqual(
            component.POTENTIAL_BASED_DIFFERENCE_TERMINAL_VALUE,
    ...
    def test_calculate_get_potential_rubbish_state(self):
        ...
        self.assertAlmostEqual(
            self.SCALING_FACTOR_POTENTIAL, component.get_potential(state, terminal)
        )
    ...
    def test_calculate_get_potential_midway_value(self):
        ...
        self.assertAlmostEqual(
            self.MIDDLE_POTENTIAL, component.get_potential(state, terminal)
        )
...
class TestAngularAsmyptoticErrorComponent(unittest.TestCase):
    ...
    def get_component_constant(
        ...
        return AngularAsymptoticErrorComponent(
            name=name,
